...
- `docs/v0.7/` holds only `SPEC.md`. The prompt copies pinned by the byte-for-byte test still live in `docs/v0.6/prompts/` (`src/prompts.rs:976-995`). C10 moves them to `docs/v0.7/prompts/`. This spec moves them once more, to `docs/v0.8/prompts/`, in the chunk that rewrites them.
...
Twelve chunks. The design record's six groups map to them as: V0 is group V0; V1 to V3 are group V1; V4 is group V3; V5 to V8 are group V4; V9 and V10 are group V2 and the maintenance half of V4; V11 is group V5. `Depends on` names v0.7 chunks by their C ids and chunks of this spec by their V ids.
...
**Depends on:** C25 · **Traces to:** R2, R3, R4, R5, R6, R8, N1, N2
...
**Depends on:** C28, V1 · **Traces to:** R10, R11, N3, N4
...
**Depends on:** V3, V5 · **Traces to:** R13, N5
...
**Depends on:** V6 · **Traces to:** R14, N3
...
**Depends on:** C11, V4, V7 · **Traces to:** R15, R16, R17, R18, N3, N5
...
**Depends on:** C16, C32, V1 · **Traces to:** R19, R20
...
**Depends on:** C24, V9 · **Traces to:** R21
...
**Depends on:** C17, C22, V3 · **Traces to:** R22, R23, N2
